        ...
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://marketplace.canva.com/MAB7yqsko0c/1/screen_2x/canva-smart-little-schoolgirl--MAB7yqsko0c.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Modifier les informations relatives aux depenses</h5>
                        <form action="{{ url('depenses/update3/'.$depense->iddep) }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label>Date</label>
                                <input value="{{ $depense->datedep }}" name="datedep" type="date" class="form-control"  placeholder="Entrez la date">
                            </div>
                            <div class="form-group">
                                <label>Nature</label>
                                <input value="{{ $depense->libelledep }}" name="libelledep" type="text" class="form-control"  placeholder="Entrez la nature de la depense">
                            </div>

                            
                            <div class="form-group">
                                <label>Libellés</label>
                                <input value="{{ $depense->creancier }}" name="creancier" type="text" class="form-control"  placeholder="Entrez le nom du créancier">
                            </div>
                            
                            <div class="form-group">
                                <label>Montant</label>
                                <input value="{{ $depense->montantdep }}" name="montantdep" type="number" class="form-control"  placeholder="Entrez le montant">
                            </div>
